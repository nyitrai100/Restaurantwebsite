    ...
    <div class="grid gap-6 text-center md:grid-cols-3 lg:gap-12">
        ...
        <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
                <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=2960&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="w-32 rounded-full shadow-lg dark:shadow-black/30" />
            </div>
        ...
        <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
                <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=1760&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="w-32 rounded-full shadow-lg dark:shadow-black/30" />
            </div>
        ...
        <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
                <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=2960&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="w-32 rounded-full shadow-lg dark:shadow-black/30" />
            </div>
